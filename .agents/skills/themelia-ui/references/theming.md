...
`src/styles/TOKENS.md` (`node_modules/themelia-ui/src/styles/TOKENS.md`) names the token for each role.
...
`src/styles/FACTORS.md` (`node_modules/themelia-ui/src/styles/FACTORS.md`) is the authority.
...
`src/styles/SCOPES.md` (`node_modules/themelia-ui/src/styles/SCOPES.md`) shows the selectors.
